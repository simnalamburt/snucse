...
인용이 모호한 경우가 많다. 그런 경우 관련 문헌의 스타일을 따라가거나 자유롭게. 융통성 발휘 필요

> 저자명, loc. cit.

직전 같은 저자명 중 같은 페이지.

심지어 Ibid 뒤에 페이지 안쓰는 경우도 부지기수다. 변용하거나 자기맘대로 쓰는사람이 많다.

> 26페이지 6번.

이건 그닥 좋은 인용은 아니나 이해해주자.

> 4번

여러권짜리 책이면 제목 바깥에 권 수를 씀.
...
이건 내주의 참고문헌이다!! 외주에서 이렇게 쓰면 안됨. "저자. 책제목. 출판사. 출판연도." 꼴의 외주와는 다르게, 내주의 참조문헌은 다르게 생겼음.

참고문헌은 저자명의 가나다, 알파벳 오름차순에 따라 배열함. 번호 안붙임.

> Eagleton, Terry(1983), *Literary Theory*: An Introduction, Oxford: Blackwell.

참고문헌은 성, 이름 순서로 쓴다. 영어권의 관습임. 찾기 편하라고. 한국과는 다르게 서구권에선 성이 더 유니크하니까.

책이 여러 판(edition)이 있을경우 교재 28페이지처럼 출판사명 뒤에 쓰면 됨.

책 맨 뒤에 판권지를 보고 인용함.

> 서울대학교 글쓰기의기초 편찬위원회 편, "글쓰기의 기초", 서울대학교출판문화원, 2015

펴낸이는 출판사 대표. 편집자도 저자도 아니고 아무도 아니지만, 판권을 판매할때엔 중요한 정보. 우리랑은 관계없음.

출판연도는 발행연도 기준. 1쇄 발행연도를 기준으로함.

- Q: 인용 형식 무조건 교재랑 똑같이 해야되나?
- A: 출판시장에서 많이 쓰는 방식을 가져와서 그걸 연습하고있는거. 그쪽 분야에서 많이 쓰는 스타일이 있으면 걍 그렇게 하시면 된다. 우리 강좌에선 우리 교재의 룰을 따른다.
- Q: <지혜의 도시, 지혜의 건축> 저자명 왜 없음??
- A: 승효상(직전 저자명) 두번 쓰기 귀찮아서..
...
내각주 방식을 사용하지 않은 글의 참고문헌 작성법.

- 저자명, 저서명, 판수, 출판지명: 출판사명, 출판 연도.
- 필자명, 논문명, 게재지명 및 권호수, 출간학회, 출판 연도.

출판사를 통해 출판하지 않은 자료는 어떻게 표시할 것인가?

ex) 학술 저널에 실린 논문. 출판되지 않은 학위논문

출판되지 않은 학위논문은 어떻게 할까? 출판사 부분에 대학교와 어느 학위 논문인지 쓴다.

> 박우준, <강원도 청소년의 운동생활습관과 주관적 건강행태와의 연관성>, 강원대학교 석사논문, 2018.

석사논문을 줄여서 TM(Thesis of Master), 박사논문을 줄여서 TD 라고 쓴다. 서지사항에서 하나짜리 낫표 혹은 화살괄호를 쓴다.

김유정 단편선같은거, 연속된 글들을 묶은거는 이렇게 한다.

- 글 저자, 〈글 이름〉, 책 저자, 《책 이름》, 출판사, 출판 연도

저널 게재 논문은..

> 윤준선·유보영, 〈청소년 시설 이용실태 및 개선방안에 대한 연구: 용인시 청소년 수련시설 중심으로〉, 《청소년시설환경》 Vol.8 No.3, 한국청소년시설환경학회, 2010, pp.59-67.
>
> 윤준선·유보영, 〈청소년 시설 이용실태 및 개선방안에 대한 연구: 용인시 청소년 수련시설 중심으로〉, 《청소년시설환경》 8(3), 한국청소년시설환경학회, 2010, pp.59-67.
>
> 윤준선·유보영, 〈청소년 시설 이용실태 및 개선방안에 대한 연구: 용인시 청소년 수련시설 중심으로〉, 《청소년시설환경》 8-3, 한국청소년시설환경학회, 2010, pp.59-67.

학회는 출판사보단 편저자에 가깝다. 그러나 출판사 자리에 쓸게 필요해서 여기에 써야한다.

외서는 저널이름만 쓰고 학회이름을 잘 안쓴다. 국내에서 학회이름을 자주 쓰는 이유가 멀까? 학회지 이름이 다들 비슷비슷해서. "경제학연구"라는 학회지만 엄청많다.

"참고문헌"에서 쓰는 면수는 인용면수가 아니라 게재 면수임. 참고문헌에서 면수 쓰는 경우는 이렇게 저널논문같은거 딱 하나다.

참고문헌은 무조건 나열하는게 아니라 분류해서 나열할수도 있다.

- 정운영, 〈라틴 아메리카 사회의 형태 규정에 필요한 몇 가지 요인에 대한 고찰〉, 《국가독점자본주의 이론 연구》, 돌베개 출판사, 1988, pp.35-38.
- 강만길, op.cit., p.105.

(내가 풀음) 잘해써요

- 나: 이거 쩜 하나 덜찍으면 깎이고 그러나요?
- 제가 젊었을때엔 깎았을텐데.. 요즘은 한없이 자애로워져서 잘 모르겠어요

마저 풀음

> 조순·정운찬, 《경제학원론》, 수정증보판, 서울:법문사, 1990, p.204.

저자 순서 바꾸면 안된다. 주석과 참고문헌은 약속이다. 도서관, 서점, 등등 모든곳에서 똑같은 형태로 나와야 편하게 찾을 것 아니냐. 저자 순서, 누가 편자인지, 이런거 다 출판지에 있는걸 그대로 써야한다. 우리는 배치만 하는것.

> 장시원, 〈일제하 농민층 분해의 양상과 그 성격〉, 차기벽 편, 《일제의 한국식민통치》, 서울:정음사, 1985, p.108.

편 또는 엮음 이라고 하면 댄다.

- 나: 이 책 혹시 답지있나여?
- 너무 뻔해서 없는거같아요
- 나: 지난번에 서울 자명해서 안써도 된다고 배웠는데, 시험에서 서울을 빼먹으면 틀린건가여?
- 안써도 되는데 걍 해봤어요

인용주 디버깅 실습

- 인용주를 달아야 하는 부분인가 를 판단해야함. 다른 사람의 글을 인용한 다음 달아야함. 내 주장 뒤에 인용주를 다는것은 부적절함.
- 0호는 무의미하다. 빼삼
- 저널은 학회 써야함
- 저널 이름과 저널 권호수 사이에는 쉼표 없음 

참고문헌 디버깅

- 넘버링 하면 안된다. 저자 가나다순으로 나열

인용주 디버깅 내 글로 실습

- 흔히 알려진것은 주석 안써도 됨.
- 나: 주석 문장 맨뒤에만 써야하나?
- 어떤 분은 어절단위로 달아야 한다고 보기도 한데, 별 상관없다. 관습의 문제.

보고서! 학교에서 안다뤘다. 보고서는 단행본에 준하나, 출판하지 않는다.

> 과학기술정보통신부, 《정보보호 실태조사 요약보고서》, 과학기술정보통신부, 2018, p.26.

논문 제목은 이탤릭체 처리 하지 않는다. 그리고 프로시딩 논문들은 어케 인용하냐? 출판사 부분에 "한국비평학회 발표논문" 이렇게 쓰면 프로시딩인줄 안다.

단행본은 이탤릭, 작은 글은 쌍따옴표.

프로시딩의 경우 프로시딩은 짧은 글, 발표회 전체가 단행본이 된다.

- 나: 세미콜론 사이사이에 온점?
- 안함

> Chung, Emily, “Antivirus software is ‘increasingly useless’ and may make your computer less safe”, *CBC*, 2016.

CBC는 교재 26페이지의 중앙일보랑 비슷한 개념이어서 이탤릭체
...
- 국내에서 규제를 하는것만으로도 영향이 있다.
- "국내 공공기관에서 열심히 블록체인을 활용하고있다"를 서론에서 사례로 알려주자

전개부:

- 2장에서 문제 사례를 제시해서 독자에게 상황을 이해시켜야함
- 2장이 3장 주장의 근거가 되어야함

문제 해결책이 현실적이고 구체적이 되어야함

- 거래량 제한
- 거래량 어케 제한할거냐 -> 공공에서 받지 말아야한다
- 중국에서 블록체인을 규제하듯이 규제해야함

범위를 좁혀서 할 수 있는 이야기 안에서 디테일하게 이야기하자. "규제" 단 하나에 대해서만 이야기해봐도 좋을 것 같음.
