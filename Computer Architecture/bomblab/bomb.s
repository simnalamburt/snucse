...
08048dcc <phase_6>:
 ...
 8048e52:	8b 5c 24 10          	mov    0x10(%esp),%ebx
 8048e56:	8b 44 24 14          	mov    0x14(%esp),%eax
 8048e5a:	89 43 08             	mov    %eax,0x8(%ebx)
 8048e5d:	8b 54 24 18          	mov    0x18(%esp),%edx
 8048e61:	89 50 08             	mov    %edx,0x8(%eax)
 8048e64:	8b 44 24 1c          	mov    0x1c(%esp),%eax
 8048e68:	89 42 08             	mov    %eax,0x8(%edx)
 8048e6b:	8b 54 24 20          	mov    0x20(%esp),%edx
 8048e6f:	89 50 08             	mov    %edx,0x8(%eax)
 8048e72:	8b 44 24 24          	mov    0x24(%esp),%eax
 8048e76:	89 42 08             	mov    %eax,0x8(%edx)
 8048e79:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
 8048e80:	be 05 00 00 00       	mov    $0x5,%esi
 8048e85:	8b 43 08             	mov    0x8(%ebx),%eax
 8048e88:	8b 10                	mov    (%eax),%edx
 8048e8a:	39 13                	cmp    %edx,(%ebx)
